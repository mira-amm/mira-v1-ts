...
export class CreatePoolAndAddLiquidityScriptInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class CreatePoolAndAddLiquidityScript extends Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: CreatePoolAndAddLiquidityScriptInterface;
  declare functions: {
    main: InvokeFunction<[pool_id: [AssetIdInput, AssetIdInput, boolean], amount_0_desired: BigNumberish, amount_1_desired: BigNumberish, recipient: IdentityInput, deadline: BigNumberish], AssetOutput>;
  };

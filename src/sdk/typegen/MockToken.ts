...
export class MockTokenInterface extends Interface {
  constructor() {
    super(abi);
  }
  ...
  declare functions: {
    ...
    add_token: FunctionFragment;
    get_sub_id: FunctionFragment;
    mint_tokens: FunctionFragment;
  };
}
...
export class MockToken extends Contract {
  ...
  declare interface: MockTokenInterface;
  declare functions: {
    ...
    add_token: InvokeFunction<[name: StdString, symbol: StdString, decimals: BigNumberish], AssetIdOutput>;
    get_sub_id: InvokeFunction<[asset_id: AssetIdInput], Option<string>>;
    mint_tokens: InvokeFunction<[asset_id: AssetIdInput, amount: BigNumberish], void>;
  };

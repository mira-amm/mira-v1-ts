...
export class RemoveLiquidityScriptInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class RemoveLiquidityScript extends Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: RemoveLiquidityScriptInterface;
  declare functions: {
    main: InvokeFunction<[pool_id: [AssetIdInput, AssetIdInput, boolean], liquidity: BigNumberish, amount_0_min: BigNumberish, amount_1_min: BigNumberish, recipient: IdentityInput, deadline: BigNumberish], [BN, BN]>;
  };

...
import { RemoveLiquidityScript } from "./RemoveLiquidityScript";
...
export class RemoveLiquidityScriptFactory extends ContractFactory {

  static readonly bytecode = bytecode;

  constructor(accountOrProvider: Account | Provider) {
    super(bytecode, RemoveLiquidityScript.abi, accountOrProvider);
  }

  static async deploy (
    wallet: Account,
    options: DeployContractOptions = {}
  ): Promise<DeployContractResult<RemoveLiquidityScript>> {
    const factory = new RemoveLiquidityScriptFactory(wallet);

    return factory.deploy({
      storageSlots: RemoveLiquidityScript.storageSlots,
      ...options,
    });
  }
}

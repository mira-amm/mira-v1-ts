...
export class SwapExactInputScriptInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class SwapExactInputScript extends Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: SwapExactInputScriptInterface;
  declare functions: {
    main: InvokeFunction<[amount_in: BigNumberish, asset_in: AssetIdInput, amount_out_min: BigNumberish, pools: Vec<[AssetIdInput, AssetIdInput, boolean]>, recipient: IdentityInput, deadline: BigNumberish], Vec<[BN, AssetIdOutput]>>;
  };

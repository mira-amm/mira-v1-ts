...
export class SwapExactOutputScriptInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class SwapExactOutputScript extends Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: SwapExactOutputScriptInterface;
  declare functions: {
    main: InvokeFunction<[amount_out: BigNumberish, asset_out: AssetIdInput, amount_in_max: BigNumberish, pools: Vec<[AssetIdInput, AssetIdInput, boolean]>, recipient: IdentityInput, deadline: BigNumberish], Vec<[BN, AssetIdOutput]>>;
  };
